...
class ClientApp(FlaskView):
    ...
    def _enabled_disable_system(self, enable):
        mqtt_topic = "FWH/2311/Micro850-8.ie.ncsu.edu/SystemCommand"
        dataObj={}
...
mqtt_host = "broker.hivemq.com"  # Can be used for local testing        
#mqtt_host = "test.mosquitto.org"
db_host = "postgresql://final_project_81kg_user:xeBI3RLvhlHimuK2iCbDl9iAZLp5A4Qa@dpg-csvqd5q3esus7382kdk0-a.oregon-postgres.render.com/final_project_81kg"
